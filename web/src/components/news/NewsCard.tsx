...
//   return (
//     <div className="group rounded-xl overflow-hidden cursor-pointer transition-all duration-200"
...
//   return (
//     <div className="group flex gap-4 p-4 rounded-xl cursor-pointer transition-all duration-150"
//       style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
