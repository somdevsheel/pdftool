...
// //             {[['Edit', '#edit'], ['Convert', '#convert'], ['E-Sign', '#esign']].map(([label, href]) => (
...
// //     summary: 'The latest model shows major gains in multi-step logic and code generation benchmarks.',
// //     time: '2h ago',
// //     source: 'TechCrunch',
// //   },
// //   {
...
// //     tag: 'Security',
// //     tagColor: '#E8526A',
// //     title: 'Critical vulnerability found in popular PDF readers',
// //     summary: 'Security researchers have disclosed a zero-day affecting multiple desktop PDF applications.',
// //     time: '4h ago',
// //     source: 'The Verge',
// //   },
// //   {
...
// //     tag: 'Cloud',
// //     tagColor: '#3FC87A',
// //     title: 'Google Drive adds native PDF annotation support',
// //     summary: 'Users can now highlight, comment, and draw directly on PDFs stored in Drive without downloads.',
// //     time: '6h ago',
// //     source: 'Wired',
// //   },
// //   {
...
// //     tag: 'Tools',
// //     tagColor: '#F5A623',
// //     title: 'Adobe Acrobat announces AI-powered document summarization',
// //     summary: 'New AI assistant can condense lengthy documents and answer questions about their content.',
// //     time: '1d ago',
// //     source: 'Engadget',
// //   },
// //   {
...
// //     tag: 'Web',
// //     tagColor: '#C17EE8',
// //     title: 'Chrome 122 improves PDF rendering performance',
// //     summary: 'Latest Chrome update brings 40% faster PDF load times and better text selection accuracy.',
// //     time: '1d ago',
// //     source: 'Ars Technica',
// //   },
// // ];
...
// // function TechNewsCard({ item }: { item: typeof TECH_NEWS[0] }) {
// //   return (
// //     <div className="flex flex-col gap-2 p-4 rounded-lg cursor-pointer transition-all duration-150"
...
// //       </div>
// //       <h4 className="text-sm font-semibold leading-snug" style={{ color: 'var(--text)' }}>{item.title}</h4>
// //       <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>{item.summary}</p>
// //       <p className="text-xs font-mono mt-1" style={{ color: 'var(--text-muted)', opacity: 0.6 }}>via {item.source}</p>
// //     </div>
// //   );
// // }
...
// //           <nav className="hidden md:flex items-center gap-1 text-sm">
// //             {[['Edit', '#edit'], ['Convert', '#convert'], ['E-Sign', '#esign'], ['Tech News', '#technews']].map(([label, href]) => (
// //               <a key={href} href={href} className="nav-link px-4 py-2 rounded text-sm transition-all duration-150">
// //                 {label}
// //               </a>
// //             ))}
...
// //         {/* Tech News */}
// //         <section id="technews" style={{ borderTop: '1px solid var(--border)', paddingTop: '3rem' }}>
// //           <div className="flex items-center gap-4 mb-6">
// //             <div className="flex items-center gap-2">
// //               <span className="text-base">⚡</span>
// //               <h2 className="text-base font-semibold whitespace-nowrap" style={{ color: 'var(--text)' }}>Tech News</h2>
// //             </div>
// //             <div className="flex-1" style={{ height: '1px', background: 'var(--border)' }} />
...
// //             <a href="#" className="text-xs font-mono transition-all duration-150"
