...
//  1.0  Homepage
//  0.9  Primary SEO tool pages (one-per-intent, fully built)
//  0.7  Long-tail keyword variants + conversion tools
//  0.5  Supporting / e-sign / other pages
//
// NOTE: Only list canonical, indexable URLs here. Do NOT include:
//   • legacy short routes that 301-redirect (/merge, /compress, /ocr, ...) —
//     they belong in next.config.js redirects, not the sitemap.
//   • internal, non-landing paths (/viewer, /api) — those stay out of indexing.
// Every URL below must also be crawlable (not disallowed in robots.ts).
