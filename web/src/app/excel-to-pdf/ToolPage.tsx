...
//           <UploadBox onFiles={handleDrop} maxFiles={1} label="Drop an Excel file (.xls, .xlsx)" accept=".xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
