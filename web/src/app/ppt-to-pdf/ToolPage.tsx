...
// export default function PptToPdfToolPage() {
...
//   return (
//     <ToolLayout title="PPT to PDF" tagline="Convert PowerPoint presentations to PDF — one page per slide." icon="📊" accentColor="#E8522A">
//       {phase === 'upload' && (
//         <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
//           <UploadBox onFiles={handleDrop} maxFiles={1} label="Drop a PowerPoint file (.ppt, .pptx)" accept=".ppt,.pptx,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation" />
...
//           <ProgressBar job={job} />
//           <p style={{ marginTop: 16, fontSize: 13, color: 'var(--text-muted)' }}>Converting PowerPoint to PDF with LibreOffice…</p>
//         </div>
//       )}
...
export default function PptToPdfToolPage() {
  ...
  return (
    <ToolLayout title="PPT to PDF" tagline="Convert PowerPoint presentations to PDF — one page per slide." icon="📊" accentColor="#E8522A">
      {phase === 'upload' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <UploadBox onFiles={handleDrop} maxFiles={1} label="Drop a PowerPoint file (.ppt, .pptx)"
