...
// const CANONICAL   = 'https://www.freenoo.com/esign-template';
...
const faqs = [
  { q: 'Are Freenoo signature templates legally binding?', a: 'Yes, professional formats compliant with Indian Contract Act and global standards. Always get legal review for high-value agreements.' },
  { q: 'Can I customize template fields before signing?', a: 'Yes, edit all text fields, dates, amounts using the built-in Edit PDF tool before signing.' },
  { q: 'Do I need signup to use templates?', a: 'No, browse, customize, sign, and download instantly without accounts.' },
  { q: 'Are templates available in multiple languages?', a: 'Currently in English; Hindi and regional language templates coming soon.' },
  { q: 'Can I save customized templates for reuse?', a: 'Yes, download your customized version and reuse it for future projects.' },
  { q: 'Are invoices GST-compliant?', a: 'Invoice templates include GST fields compliant with Indian tax regulations.' },
];

const relatedTools = [
  { href: '/fill-sign',          label: 'Fill & Sign',       desc: 'Complete your customized template' },
  { href: '/request-signatures', label: 'Request Signature', desc: 'Send templated document for approval' },
  { href: '/add-signature',      label: 'Add Signature',     desc: 'Create signature to use on templates' },
];

const body = [
  'Professional, legally-vetted PDF templates for common documents—contracts, invoices, NDAs, rental agreements. Customize fields, add your data, then sign instantly.',
  <>
    <strong>Why use Freenoo Signature Templates?</strong>
    <ul style={{ marginTop: 8, paddingLeft: 18, lineHeight: 2 }}>
      <li>20+ pre-made templates covering business, legal, HR documents</li>
      <li>Fully customizable—edit text fields, dates, amounts before signing</li>
      <li>Legally compliant formats for India and global use</li>
      <li>100% free—no signup, instant download after customization</li>
    </ul>
  </>,
  <>
    <strong>Popular templates available:</strong>
    <ul style={{ marginTop: 8, paddingLeft: 18, lineHeight: 2 }}>
      <li>Freelance Contract — scope, payment terms, deliverables</li>
      <li>Invoice Template — professional billing format</li>
      <li>NDA Template — non-disclosure agreements</li>
      <li>Rental Agreement — house/vehicle lease contracts</li>
      <li>Employment Offer Letter — HR hiring documents</li>
    </ul>
  </>,
  'Perfect for: businesses, freelancers, HR teams, landlords, and anyone needing ready-to-sign professional documents.',
];
