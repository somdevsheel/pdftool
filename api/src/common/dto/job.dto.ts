...
//   @IsString() @IsNotEmpty() fileId: string;
//   @IsOptional() instructions?: EditInstruction[];
// }
...
// }
// export class OfficeToPdfJobDto {
//   @IsString() @IsNotEmpty() fileId: string;
// }
...
// export class ConvertJobDto {
//   @IsArray() @IsNotEmpty() fileIds: string[];
//   @IsOptional() @IsString() fileId?: string; // back-compat single upload
// }
