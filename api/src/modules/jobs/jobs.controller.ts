...
//     return successResponse(await this.jobsService.createMergeJob(dto), 'Merge job queued');
//   }

//   @Post('jobs/split')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async split(@Body() dto: SplitJobDto) {
//     return successResponse(await this.jobsService.createSplitJob(dto), 'Split job queued');
//   }

//   @Post('jobs/compress')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async compress(@Body() dto: CompressJobDto) {
//     return successResponse(await this.jobsService.createCompressJob(dto), 'Compress job queued');
//   }

//   @Post('jobs/rotate')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async rotate(@Body() dto: RotateJobDto) {
//     return successResponse(await this.jobsService.createRotateJob(dto), 'Rotate job queued');
//   }

//   @Post('jobs/convert')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async convert(@Body() dto: ConvertJobDto) {
//     return successResponse(await this.jobsService.createConvertJob(dto), 'Convert job queued');
//   }

//   @Post('jobs/edit')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async edit(@Body() dto: EditJobDto) {
//     return successResponse(await this.jobsService.createEditJob(dto), 'Edit job queued');
//   }

//   @Post('jobs/pages')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async pages(@Body() dto: PagesJobDto) {
//     return successResponse(await this.jobsService.createPagesJob(dto), 'Pages job queued');
//   }

//   @Post('jobs/pdf-to-img')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async pdfToImg(@Body() dto: PdfToImgJobDto) {
//     return successResponse(await this.jobsService.createPdfToImgJob(dto), 'PDF→Image job queued');
//   }

//   @Post('jobs/office-to-pdf')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async officeToPdf(@Body() dto: OfficeToPdfJobDto) {
//     return successResponse(await this.jobsService.createOfficeToPdfJob(dto), 'Office→PDF job queued');
//   }

//   @Post('jobs/pdf-to-office')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async pdfToOffice(@Body() dto: PdfToOfficeJobDto) {
//     return successResponse(await this.jobsService.createPdfToOfficeJob(dto), 'PDF→Office job queued');
//   }
...
//     return successResponse(await this.jobsService.getJob(id));
//   }

//   @Get('jobs')
//   getAllJobs() {
//     return successResponse(this.jobsService.getAllJobs());
//   }
...
//     // Probe for actual file — worker appends extension (.jpg/.png/.zip etc)
//     const base = job.outputPath || '';
//     const candidates = [
//       base,
//       `${base}.jpg`, `${base}.png`, `${base}.zip`,
//       `${base}.pdf`, `${base}.docx`, `${base}.pptx`, `${base}.xlsx`,
//     ];
...
//     const extMatch = resolvedPath.match(/\.(zip|pdf|jpg|jpeg|png|docx|pptx|xlsx)$/i);
...
//   @HttpCode(HttpStatus.ACCEPTED)
//   async pdfToImg(@Body() dto: PdfToImgJobDto) {
//     return successResponse(await this.jobsService.createPdfToImgJob(dto), 'PDF to Image job queued');
//   }

//   @Post('jobs/office-to-pdf')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async officeToPdf(@Body() dto: OfficeToPdfJobDto) {
//     return successResponse(await this.jobsService.createOfficeToPdfJob(dto), 'Office to PDF job queued');
//   }

//   @Post('jobs/pdf-to-office')
//   @HttpCode(HttpStatus.ACCEPTED)
//   async pdfToOffice(@Body() dto: PdfToOfficeJobDto) {
//     return successResponse(await this.jobsService.createPdfToOfficeJob(dto), 'PDF to Office job queued');
//   }
