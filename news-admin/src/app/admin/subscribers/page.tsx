...
//           <p className="text-sm" style={{ color: '#888' }}>Subscribers appear here once they sign up via the sidebar or popup</p>
//         </div>
//       ) : (
...
//                       style={{
//                         background: sub.source === 'popup' ? '#2B5EE822' : '#05966922',
//                         color: sub.source === 'popup' ? '#2B5EE8' : '#059669',
//                       }}>
//                       {sub.source}
//                     </span>
//                   </td>
