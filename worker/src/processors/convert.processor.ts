...
//   console.log(`[Convert] Processing job ${jobId}`);
...
//   // img2pdf requires the output to have a .pdf extension
//   const finalOutput = outputPath.endsWith('.pdf') ? outputPath : outputPath + '.pdf';

//   await commandService.imageToPdf(inputPath, finalOutput);

//   await job.updateProgress(90);

//   if (!fileService.fileExists(finalOutput)) {
//     throw new Error('Convert produced no output');
//   }
