...
//           return processMerge(job as any, commandService, fileService);
//         case JOB_TYPES.SPLIT:
//           return processSplit(job as any, commandService, fileService);
//         case JOB_TYPES.COMPRESS:
//           return processCompress(job as any, commandService, fileService);
//         case JOB_TYPES.ROTATE:
//           return processRotate(job as any, commandService, fileService);
//         case JOB_TYPES.CONVERT:
//           return processConvert(job as any, commandService, fileService);
//         case JOB_TYPES.EDIT:
//           return processEdit(job as any, fileService);
//         case JOB_TYPES.PAGES:
//           return processPages(job as any, commandService, fileService);
//         case JOB_TYPES.PDF_TO_IMG:
//           return processPdfToImg(job as any, commandService, fileService);
//         case JOB_TYPES.OFFICE_TO_PDF:
//           return processOfficeToPdf(job as any, commandService, fileService);
//         case JOB_TYPES.PDF_TO_OFFICE:
//           return processPdfToOffice(job as any, commandService, fileService);
//         default:
